...
<!-- Mirrored from doccure-html.dreamguystech.com/template/admin/transactions-list.php by HTTrack Website Copier/3.x [XR&CO'2017], Tue, 12 Jan 2021 13:01:40 GMT -->
<head>
        <meta charset="utf-8">
                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li><a href="product-list.php"><i class="fe fe-layout"></i> <span>Product List</span></a></li>
							<li><a href="pharmacy-list.php"><i class="fe fe-vector"></i> <span>Pharmacy List</span></a></li>
							<li> 
...
<!-- Mirrored from doccure-html.dreamguystech.com/template/admin/transactions-list.php by HTTrack Website Copier/3.x [XR&CO'2017], Tue, 12 Jan 2021 13:01:41 GMT -->
</html>